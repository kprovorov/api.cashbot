---
to: app/<%= h.changeCase.pascal(h.inflection.singularize(module)) %>Module/Requests/Update<%= h.changeCase.pascal(h.inflection.singularize(name)) %>Request.php
---
<?php
...
class Update<%= h.changeCase.pascal(h.inflection.singularize(name)) %>Request extends FormRequest
{
    /**
